...
Наименьшее значение MSE на тестовой выборке соответствует числу степеней свободы 4 и равно 1.15. Это и есть компромисс между простотой и точностью модели.
...
Теперь изменим процент обучающей выборки с 0.85 до 0.90
...
Если сравнивать данные модели, то можно заметить, что, естественно, вторая модель будет ближе к истинной зависимости, так как она строилась на большей обучающей выборке. Изменение MSE также связан с изменением объема обучающей выборки. Увеличив обучающую выборку - сократили тестовую. В связи с чем получили отличие в MSE.
